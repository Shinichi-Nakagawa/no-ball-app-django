"""
Django settings for noball project.
...
SECRET_KEY = '6hkvm_u13a%6)^zrnsg*x=d1l_5it9_)qa456(q8letw!r+f3k'
...
ROOT_URLCONF = 'noball.urls'

WSGI_APPLICATION = 'noball.wsgi.application'
